...
mumax3 koerner2022frequency/S11_simulation_MumaxScript_step.mx3

mumax3-convert -numpy koerner2022frequency/S11_simulation_MumaxScript_step.out/*.ovf
