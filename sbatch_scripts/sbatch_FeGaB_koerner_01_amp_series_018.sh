...
#SBATCH --ntasks=1
#SBATCH --time=4:00:00
#SBATCH --job-name=FeGaB_koerner_01_amp_series
...
mumax3 my_mx3_files/FeGaB_koerner_01_amp_series_018.mx3

mumax3-convert -numpy my_mx3_files/FeGaB_koerner_01_amp_series_018.out/*.ovf
