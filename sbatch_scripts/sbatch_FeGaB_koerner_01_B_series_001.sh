...
#SBATCH --ntasks=1
#SBATCH --time=4:00:00
#SBATCH --job-name=FeGaB_koerner_01_B_series
...
mumax3 my_mx3_files/FeGaB_koerner_01_B_series_001.mx3

mumax3-convert -numpy my_mx3_files/FeGaB_koerner_01_B_series_001.out/*.ovf
