...
mumax3 koerner2022frequency/Fig4A_simulation_MumaxScript_stripe.mx3

mumax3-convert -numpy koerner2022frequency/Fig4A_simulation_MumaxScript_stripe.out/*.ovf
