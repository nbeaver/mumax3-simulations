...
#SBATCH --ntasks=1
#SBATCH --time=4:00:00
#SBATCH --job-name=tweak_Fig4AB_step_002_FeGaB
...
mumax3 my_mx3_files/tweak_Fig4AB_step_002_FeGaB.mx3

mumax3-convert -numpy my_mx3_files/tweak_Fig4AB_step_002_FeGaB.out/*.ovf
